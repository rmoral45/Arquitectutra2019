...
#set_property PACKAGE_PIN T2 [get_ports {i_i_switch[10]}]					
...
#set_property PACKAGE_PIN W2 [get_ports {i_i_switch[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {i_switch[12]}]
#set_property PACKAGE_PIN U1 [get_ports {i_i_switch[13]}]					
...
set_property PACKAGE_PIN N3 [get_ports {o_led_dbg[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {o_led_dbg[0]}]
set_property PACKAGE_PIN P1 [get_ports {o_led_dbg[1]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {o_led_dbg[1]}]
set_property PACKAGE_PIN L1 [get_ports {o_led_dbg[2]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {o_led_dbg[2]}]
